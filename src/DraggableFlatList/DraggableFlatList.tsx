...
function DraggableFlatListInner<T>(props: DraggableFlatListProps<T>) {
  ...
  let [activeKey, setActiveKey] = React.useState<string | null>(null);
  const [layoutAnimationDisabled, setLayoutAnimationDisabled] = React.useState(
  ...
  if (WEB && DraggableFlatListWeb) {
    ...
    return (
      <DraggableFlatListWeb
        ...
        containerStyle={
          containerStyle ? (containerStyle as React.CSSProperties) : undefined
        }
