...
Set-Content -Path "$env:TEMP\envfile" -Value ".env.production"

# change google-services files
# Copy-Item "documents/google-services/google-services-pro.json" "android/app/google-services.json" -Force
# Copy-Item "documents/google-services/google-services-pro.plist" "ios/GoogleService-Info.plist" -Force
